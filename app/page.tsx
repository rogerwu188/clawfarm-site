        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid-3 mt-8" style={{gridTemplateColumns:'repeat(3, 1fr)', gap:'20px'}}>
            ...
            <div className="grid-cell" style={{borderTop:'3px solid var(--accent)', paddingTop:'24px'}}>
              ...
              <div style={{marginTop:'20px', display:'flex', flexDirection:'column', gap:'8px'}}><Link href="/docs" style={{fontFamily:'var(--font-mono)', fontSize:'12px', color:'#1a1a1a', background:'#60a5fa', border:'1px solid #60a5fa', borderRadius:'4px', padding:'8px 14px', textAlign:'center', display:'block', fontWeight:600}}>Build with SDK</Link></div>
            </div>
            <div className="grid-cell" style={{borderTop:'3px solid var(--amber)', paddingTop:'24px'}}>
              ...
              <div style={{marginTop:'20px', display:'flex', flexDirection:'column', gap:'8px'}}><Link href="/install" style={{fontFamily:'var(--font-mono)', fontSize:'12px', color:'#1a1a1a', background:'#fbbf24', border:'1px solid #fbbf24', borderRadius:'4px', padding:'8px 14px', textAlign:'center', display:'block', fontWeight:600}}>Set Up a Node</Link></div>
            </div>
          </div>
        </div>
      </section>
